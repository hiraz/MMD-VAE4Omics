...
path = 'C:/Research/Python-DL-for-my-research/MMD_VAE4Omics/scripts/latent-features-learning/early_stoping_checkpoint/checkpoint.pt'

class Earlystopping:
    def __init__(self, number=75, path= path):
        self.number = number
        self.path = path
        self.counter = 0
        self.epoch_count = 0
